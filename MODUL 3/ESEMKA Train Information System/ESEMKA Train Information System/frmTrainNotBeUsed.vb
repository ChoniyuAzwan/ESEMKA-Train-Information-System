...
Public Class frmTrainNotBeUsed
    Sub ShowData()
        ...
        Try
            ...
            With Cmd
                .Connection = Con
                .CommandText = "select * from TrainNotBeUsed"
            End With
            ...
            If dgvData.Columns(I).Visible Then
                If dgvData.Columns(I).Name = cbTitle.SelectedItem Then
                    Try
                        ...
                        With Cmd
                            .Connection = Con
                            .CommandText = "select * from TrainNotBeUsed where " & dgvData.Columns(I).Name & " like '%" & txtSearch.Text & "%'"
                        End With
                        Da.SelectCommand = Cmd
                        Dt.Clear()
                        Da.Fill(Dt)
    ...
    Private Sub frmTrainNotBeUsed_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ShowData()
