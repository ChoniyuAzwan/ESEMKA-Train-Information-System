...
Public Class frmTrainScheduling
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If Q = vbYes Then
            Try
                ...
                With Cmd
                    .Connection = Con
                    .CommandText = "delete TrainScheduling where idscheduling = '" & dgvData.SelectedRows(0).Cells(0).Value & "'"
                    R = .ExecuteNonQuery
                End With
                If R > 0 Then
    ...
    Private Sub frmTrainScheduling_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ShowData()
